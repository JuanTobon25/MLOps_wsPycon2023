...
import argparse
import wandb
from sklearn.ensemble import RandomForestClassifier  # Importamos el RandomForestClassifier
...
with wandb.init(project="EXPERIENCIAS", name=f"Train Model ExecId-{args.IdExecution}", job_type="train-model") as run:
    ...
    model_path = "./model/iris_rf_model.joblib"  # Cambié el nombre del archivo para el modelo de RandomForest
    ...
    if os.path.exists(model_path):
        ...
        model = RandomForestClassifier(n_estimators=50, random_state=42)  # Usamos RandomForestClassifier
    ...
    # --- Save trained model ---
    trained_model_path = "./model/iris_rf_model_trained.joblib"  # Guardamos el modelo entrenado de RandomForest
    ...
    trained_model_artifact = wandb.Artifact(
        name="iris-rf-model-trained",
        type="model",
        description="Random Forest model trained on standardized Iris dataset",
